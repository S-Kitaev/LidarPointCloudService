...
Если вам необходима только какая-то часть настройки платы, переходите к соответствующему 
разделу.
...
[raspberry/build.md](https://github.com/S-Kitaev/LidarPointCloudService/blob/main/raspberry/build.md)
