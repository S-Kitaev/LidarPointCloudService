...
6. Для полноценного использования ПО совместно с установкой, выполните следующие шаги:
   ...
   - При использовании системы для ее подключения к установке - подключайтесь к Wi-Fi Лидара, находитесь на расстоянии не более 10 метров от установки
   - При использовании системы для работы с облаком точек - подключайтесь к общедоступному (личному) Wi-Fi, и для работы с ЦХД, к VPN ВИШ МИФИ
